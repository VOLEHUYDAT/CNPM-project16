...
class Voucher(models.Model):
    code = models.CharField(max_length=50, unique=True)  # Mã voucher
    discount_percentage = models.FloatField()  # Phần trăm giảm giá
    min_purchase_amount = models.IntegerField()  # Giá trị đơn hàng tối thiểu để áp dụng
    expiration_date = models.DateTimeField()  # Ngày hết hạn
    status = models.BooleanField(default=True)  # Voucher còn hiệu lực không
...
class Order(models.Model):
    ...
    #mã voucher
    # 🛠 Thêm trường voucher để lưu mã giảm giá
